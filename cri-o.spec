...
install -Dpm644 -T contrib/cni/11-crio-ipv4-bridge.conflist %{buildroot}%{_sysconfdir}/cni/net.d/87-crio-bridge.conflist
...
%{_sysconfdir}/cni/net.d/87-crio-bridge.conflist
